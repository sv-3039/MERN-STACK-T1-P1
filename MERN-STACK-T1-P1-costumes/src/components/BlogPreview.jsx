      ...
      <div className="grid grid-cols-1 gap-6 sm:grid-cols-3">
        {BLOG_POSTS.map((post, i) => (
          ...
          >
            ...
            <h3 className="mt-1.5 font-display text-lg font-semibold leading-snug text-zinc-900 group-hover:text-royal dark:text-white dark:group-hover:text-royal">{post.title}</h3>
            <p className="mt-1.5 line-clamp-2 text-sm text-zinc-600 dark:text-zinc-400">{post.excerpt}</p>
          </motion.article>
        ))}
      </div>
    </section>
