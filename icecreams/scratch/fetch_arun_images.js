...
// Curated high quality dessert/ice cream photos for Arun Ice Creams products
const arunImages = {
  ...
  'arun-icon-twist': 'https://images.unsplash.com/photo-1549395156-e0c1fe6fc7a5?auto=format&fit=crop&w=600&q=80',
  ...
  'arun-raspberry-duet': 'https://images.unsplash.com/photo-1501443762994-82bd5dace89a?auto=format&fit=crop&w=600&q=80',
  'arun-chocobar': 'https://images.unsplash.com/photo-1501443762994-82bd5dace89a?auto=format&fit=crop&w=600&q=80',
  ...
  'arun-itub-pista': 'https://images.unsplash.com/photo-1576506295286-5cda18df43e7?auto=format&fit=crop&w=600&q=80',
  'arun-itub-vanilla': 'https://images.unsplash.com/photo-1570197788417-0e82375c9371?auto=format&fit=crop&w=600&q=80',
  'arun-jumbo-cassatta': 'https://images.unsplash.com/photo-1560008581-09826d1de69e?auto=format&fit=crop&w=600&q=80',
  'arun-jumbo-choco': 'https://images.unsplash.com/photo-1560008581-09826d1de69e?auto=format&fit=crop&w=600&q=80',
  'arun-ishake-chocolate': 'https://images.unsplash.com/photo-1572490122747-3968b75cc699?auto=format&fit=crop&w=600&q=80',
  'arun-ishake-coffee': 'https://images.unsplash.com/photo-1572490122747-3968b75cc699?auto=format&fit=crop&w=600&q=80',
  'arun-cake-black-forest': 'https://images.unsplash.com/photo-1621303837174-89787a7d4729?auto=format&fit=crop&w=600&q=80',
...
async function run() {
  console.log('Downloading Arun product image files...');
  for (const [key, url] of Object.entries(arunImages)) {
  ...
  console.log('Done downloading Arun image files.');
}
